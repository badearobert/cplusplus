...
int main()
{
	...
	cout << "&obj1: \t" << obj1._Get() << endl;
	cout << "&obj2: \t" << obj2._Get() << endl;
	cout << "&obj3: \t" << obj3._Get() << endl;

	cout << "obj1" << ((obj1._Get() == obj2._Get()) ? " == " : " != ") << "obj2" << endl;
	cout << "obj1" << ((obj1._Get() == obj3._Get()) ? " == " : " != ") << "obj3" << endl;
